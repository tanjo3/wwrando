...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 908, 654))
        ...
        self.label_for_hint_placement = QLabel(self.groupBox_3)
        self.label_for_hint_placement.setObjectName(u"label_for_hint_placement")
        ...
        self.label_for_hint_type = QLabel(self.groupBox_3)
        self.label_for_hint_type.setObjectName(u"label_for_hint_type")

        self.horizontalLayout_15.addWidget(self.label_for_hint_type)

        self.hint_type = QComboBox(self.groupBox_3)
        self.hint_type.addItem("")
        self.hint_type.addItem("")
        self.hint_type.setObjectName(u"hint_type")

        self.horizontalLayout_15.addWidget(self.hint_type)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_for_hint_type.setText(QCoreApplication.translate("MainWindow", u"Hint Type", None))
        self.hint_type.setItemText(0, QCoreApplication.translate("MainWindow", u"Items", None))
        self.hint_type.setItemText(1, QCoreApplication.translate("MainWindow", u"WotH-Style", None))
